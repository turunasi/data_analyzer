...
// センサー関連係数
// 圧力センサ
#define SENS_1A 4.144556586 // 3時
#define SENS_1C 3.972407086 // 5時
#define SENS_1E 0.0         // 不使用
#define SENS_2A 4.016772575 // 7時
#define SENS_2C 0.0         // 不使用
#define SENS_2E 3.961821536 // 9時
#define SENS_3A 0.0         // 不使用
#define SENS_3C 3.958681297 // 11時
#define SENS_3E 8.018976385 // tank
#define SENS_PP 7.989149673 // 性能
