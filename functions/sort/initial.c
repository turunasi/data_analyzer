...
// do not display warning info about scan functions.
...
//#define POSIT_IN  "../../data/210701"  // input
//#define POSIT_OUT "../../data_2/210701" // output
...
int main(int argc, char *argv[]) {
  ...
  int fn = atoi(argv[1]);
	char *posit_in = argv[2];
	char *posit_out = argv[3];
